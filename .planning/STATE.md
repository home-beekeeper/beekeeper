...
**Current focus:** v1.3.0 — Web Presence & Documentation. Phase 11 (Scaffold & Toolchain Isolation) PLANNED (1 plan, plan-checker passed) — ready to execute. Seed Go work (Phase 10 hook-block, self-protection, $VAR, TUI real-data) already shipped this cycle.
