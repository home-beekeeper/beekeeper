...
| 18.1 | Docs Theme Restyle | DSYS-05 | ◆ Restyle quick-fixes LANDED 2026-06-09 (white sidebar border killed, teal/amber accents, sidebar duplication fixed via flatten; Playwright-verified 0 white borders, all specs green). Remaining: one-command-per-card copy treatment for multi-command blocks. Done as a QUICK TASK, not full phase. |
