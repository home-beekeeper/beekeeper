...
## Current Milestone: v1.5.0 — Install Posture (ships as release v1.1.0)

**Status:** 🔨 ACTIVE (started 2026-06-21). Internal GSD milestone number is **v1.5.0** (continues the v1.4.0 line; deliberately not "v1.1.0", which is the parked Pollen GSD milestone). **Ships publicly as release `v1.1.0`** (git tag + changelog + code version).
...
- Layer 3: scoped override (allow once / allow always with recorded reason / block), each written to the audit log. The deep per-rule editor is roadmap.
