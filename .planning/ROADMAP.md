...
| **21. Full-System Validation & CI Calibration** | **v1.3.0** | **0/4** | **Planned & plan-checked 2026-06-11 (4 plans / 3 waves; VAL-01..08 all covered; research-first; plan-checker PASSED 0-blocker/2-warn — W1 RESEARCH Open-Questions annotation fixed inline, W2 21-01 scope accepted). W1 coverage-gate + 17-harness conformance (parallel) → W2 Sentry fuzz + CI-matrix delta → W3 Claude-Code e2e + register + honesty docs. NEXT: /gsd-execute-phase 21** | **—** |
