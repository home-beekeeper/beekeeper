...
> 📦 **ARCHIVED — ✅ SHIPPED 2026-06-04.** All 25 requirements complete & verified: 17 v1 (SPATH×4, NUDGE×8, CORR×2, BTEST×3, Phases 6–8) + 8 cleanup (CLEAN×4, HARDEN×3, DRIFT×1, Phase 9, inserted from the milestone audit). Roadmap: [`v1.2.0-ROADMAP.md`](v1.2.0-ROADMAP.md) · Audit: [`v1.2.0-MILESTONE-AUDIT.md`](v1.2.0-MILESTONE-AUDIT.md).
