...
// installs via `go install github.com/home-beekeeper/pollen/cmd/pollen@<version>` in
...
//     (github.com/home-beekeeper/pollen) — adding one would violate the subprocess
...
//
//	go install github.com/home-beekeeper/pollen/cmd/pollen@v0.2.0
//
