...
func TestFilterCredentials(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			input:             "GitHub token: ghp_abcdefghijklmnopqrstuvwxyz012345AB",
			wantRedacted:      true,
		...
		},
		{
			...
			input:             "npm token: npm_abcdefghijklmnopqrstuvwxyz012345AB",
			wantRedacted:      true,
			wantType:          "npm-token",
			wantContainsCreds: true,
		},
		...
		},
		{
			...
			input:             "org token: gho_abcdefghijklmnopqrstuvwxyz012345AB",
			wantRedacted:      true,
			wantType:          "github-token",
			wantContainsCreds: true,
		},
		{
			...
			input:             "user token: ghu_abcdefghijklmnopqrstuvwxyz012345AB",
			wantRedacted:      true,
			wantType:          "github-token",
			wantContainsCreds: true,
		},
		{
			...
			input:             "server token: ghs_abcdefghijklmnopqrstuvwxyz012345AB",
			wantRedacted:      true,
			wantType:          "github-token",
			wantContainsCreds: true,
		},
		{
			...
			input:             "refresh token: ghr_abcdefghijklmnopqrstuvwxyz012345AB",
			wantRedacted:      true,
			wantType:          "github-token",
			wantContainsCreds: true,
		},
