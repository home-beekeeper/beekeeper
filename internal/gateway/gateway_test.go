...
// NOTE: TestGatewayNudgeMerge and TestGatewayAdvisoryCapPerSession lived here.
// They exercised the package-manager nudge merge + advisory cap, both removed in
// v1.1.0. Install posture will get its own gateway tests in a later phase.
